...
curl -d 'bbox=-13193642.578247702,3977047.2455633273,-13100389.403739786,4039419.8606440313&layers=nlcd-zoomed&weights=2&numBreaks=10&srid=3857' -X POST "http://localhost:8777/gt/breaks"

printf "\nGet Tile\n"
curl -d 'bbox=-13193642.578247702,3977047.2455633273,-13100389.403739786,4039419.8606440313&layers=nlcd-zoomed&weights=2&numBreaks=10&srid=3857&breaks=0,22,42,44,46,48,82,86,104,190' -X POST "http://localhost:8777/gt/tile/11/350/817.png" > tile.png
